...
This atomic will create a new IAM role. The default role permissions are: _IAM Service Account Get_. The idea for this Atomic came from a Rule published by the Elastic team.
