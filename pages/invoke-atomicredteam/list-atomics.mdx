...
Now that the execution framework is [installed](/invoke-atomicredteam/getting-started) and the module is [imported](/invoke-atomicredteam/import) you are ready to start using it. A good starting point is to list the Technique numbers and test names available for execution.
