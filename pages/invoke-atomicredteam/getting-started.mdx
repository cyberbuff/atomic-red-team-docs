...
### Install from PowerShell Gallery [#powershell-gallery]
...
```
Note: If you get an error relating to a missing PSRepository, use the following command to register the needed repository.
